  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="reformas-integrales-arias";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Reformas Integrales Arias"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="reformas-integrales-arias"
          data-primary-color="#67a2e2"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="reformas-integrales-arias";
